            ...
            try
            {
                ...
                if (chiTietHoaDons != null)
                {
                    ...
                    if (hoaDon.IDNguoiDung != null)
                        hoaDon1.IDKhachHang = hoaDon.IDNguoiDung;
                    ...
                    // Giảm 15% tổng hoá đơn nếu mua từ 2 món hàng trở lên
                    if (chiTietHoaDons.Count > 1)
                        hoaDon1.GiamGia = (int)(hoaDon.TongTien * 0.15);
